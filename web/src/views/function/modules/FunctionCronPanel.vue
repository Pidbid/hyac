      ...
      <NForm ref="formRef" :model="formData" :rules="rules" label-placement="left" label-width="auto">
        ...
        <NFormItem :label="$t('page.function.triggerType')">
          <NSelect
            ...
            :options="[
              { label: $t('page.function.intervalTrigger'), value: 'interval' },
              { label: $t('page.function.cronTrigger'), value: 'cron' }
            ]"
          />
        </NFormItem>
        ...
        <NFormItem v-if="formData.trigger === 'cron'" :label="$t('page.function.cronSettings')">
          <NSpace>
            ...
            <NInputGroup style="width: 120px">
              <NInput
                v-model:value="cronValues.day_of_week"
        ...
        <NFormItem :label="$t('page.function.queryParameters')">
          <div class="w-full flex flex-col gap-2">
            <div v-for="(param, index) in queryParamsList" :key="index" class="flex items-center gap-2">
        ...
        <NFormItem :label="$t('page.function.requestBody')">
          <NInput v-model:value="formBody" type="textarea" placeholder='{ "key": "value" }' resizable />
        </NFormItem>
        ...
        <NSpace justify="end">
          ...
          <NButton type="success" :disabled="!taskExists" @click="handleTrigger">
            <template #icon><NIcon :component="PlayOutline" /></template>
            {{ $t('common.trigger') }}
          </NButton>
          <NButton type="error" :disabled="!taskExists" @click="handleDelete">
