 ...
 */
export function getFunctionTemplates(appId: string, page: number, length: number, function_type?: string) {
 ...
 * @param data - The request data
 */
export function createFunctionTemplate(appId: string, name: string, code: string, type: string, shared: boolean) {
 ...
 * @param data - The request data
 */
export function updateFunctionTemplate(data: Api.FunctionTemplate.UpdateFunctionTemplateRequest) {
  return request<Api.Base.SuccessResponse>({
